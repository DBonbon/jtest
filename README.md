...
2. Include this ip on your hosts-file
    ...
    ```
    127.0.0.1 openline.site.test
    ```

    On windows you can run this command to append it:

    ```
    echo 127.0.0.1 openline.site.test >> c:\windows\System32\drivers\etc\hosts
    ```
...
4. Generate ssl certs for local development
    ```
    mkcert --cert-file docker/files/certs/cert.pem --key-file docker/files/certs/cert-key.pem openline.site.test
    ```
...
7. Install and start frontend
    ...
    npm run dev
    ```
8. Visit your site on: [https://openline.site.test:8082](https://openline.site.test:8082)
    - ...or login to [https://openline.site.test:8082/wt/cms](https://openline.site.test:8082/wt/cms) (Username: `admin` and password: `admin`)
...
Quartets is proprietary software. All rights reserved.
